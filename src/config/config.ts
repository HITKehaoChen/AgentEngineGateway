...
export interface GatewayConfig { host:string; port:number; engine:string; defaultDirectory:string; runTimeoutMs:number; maxSessions:number; maxRequestBytes:number; heartbeatMs:number; model:ResolvedModel }
